...
class AdminUserController extends Controller
{
    ...
    public function store(AdminUserStoreRequest $request)
    {
        ...
        return redirect()->route('backend.admin.index')->with('success', __('Created admin user successfully'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.admin.edit', compact('admin', 'roles', 'admin_role'));
    }
    ...
    public function update(AdminUserUpdateRequest $request, string $id)
    {
        ...
        return redirect()->route('backend.admin.index')->with('success', __('Updated admin user successfully'));
    }
