...
@section('section_body_title')
    {{ __('Edit Member Admin') }}
@endsection

@section('section_body_lead')
    {{ __('Update information about member admin on this page') }}
@endsection
                ...
                <form method="POST" action="{{ route('member.admin.update', $member->id) }}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label>{{ __('Member Admin Name') }} <x-fill-field /></label>
                        ...
                        <div class="form-group">
                            <label>{{ __('Member Admin Email') }} <x-fill-field /></label>
                                ...
                                @foreach ($roles as $key => $item)
                                    <label class="custom-switch">
                                        <input type="radio" name="role" value="{{ $key }}"
                                            ...
                                            {{ $member->roles->pluck('id')->first() == $key ? 'checked' : '' }}>
