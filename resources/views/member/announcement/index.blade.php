...
@section('section_body_lead')
    {{ __('admin.View information about announcement on this page') }}
@endsection
        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h4>{{ __('admin.All Announcement') }}</h4>
                    @if (canAccess(['announcement create']))
                        <div class="card-header-action">
                            <a href="{{ route('member.announcement.create') }}" class="btn btn-primary">
...
@push('scripts')
    <script>
        ...
        table_data = $('#table_data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route('member.announcement.data') }}',
            },
            columns: [{
                data: 'DT_RowIndex',
                searchable: false,
