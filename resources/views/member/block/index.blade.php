...
@section('section_body_lead')
    {{ __('View information about block on this page') }}
@endsection
            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('member.block.create') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        @foreach ($blocks_active as $block)
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <a href="{{ route('member.block.edit', $block->id) }}"
                                                        class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                                    <a href="{{ route('member.block.destroy', $block->id) }}"
                        ...
                        <div class="tab-pane fade" id="inactive3" role="tabpanel" aria-labelledby="inactive-tab3">
                            <div class="table-responsive">
                                <table class="table table-striped" id="table_data_inactive">
                                    ...
                                    <tbody>
                                        @foreach ($blocks_inactive as $block)
                                            <tr>
                                                <th scope="row" class="text-center align-middle">{{ $loop->iteration }}
                                                </th>
                                                <td class="align-middle">{{ $block->name ?? '' }}</td>
                                                ...
                                                <td class="text-center align-middle">
                                                    <a href="{{ route('member.block.restore', $block->id) }}"
