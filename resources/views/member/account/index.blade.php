...
@section('section_header_breadcrumb')
    @parent
    <div class="breadcrumb-item">{{ __('admin.Account') }}</div>
@endsection
...
@section('section_body_lead')
    {{ __('admin.Restore information about account on this page') }}
@endsection
