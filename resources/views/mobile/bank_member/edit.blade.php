...
@section('content')
    ...
    <div class="mt-2 mb-2 section">
        ...
        <form method="POST" action="{{ route('mobile.bank-member.update', $bank_member->id) }}">
            @csrf
            @method('PUT')
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" name="bank_account_number" id="bank_account_number"
                                value="{{ old('bank_account_number') ?? $bank_member->bank_account_number }}"
                                placeholder="{{ __('Enter account number') }}" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" name="bank_account_name" id="bank_account_name"
                                value="{{ old('bank_account_name') ?? $bank_member->bank_account_name }}"
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" name="beginning_balance" id="beginning_balance"
                                value="{{ old('beginning_balance') ?? $bank_member->beginning_balance }}"
                                placeholder="{{ __('Enter account name') }}" required>
                        </div>
                    </div>
                        ...
                        <select class="form-control custom-select select2" name="bank" id="bank" required>
                            ...
                            @foreach ($banks as $bank)
                                <option value="{{ $bank->id }}"
                                    {{ old('bank') == $bank->id ? 'selected' : ($bank_member->bank_code == $bank->code ? 'selected' : '') }}
                            ...
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" class="form-control" name="bank_code" id="bank_code"
                                        value="{{ old('bank_code') ?? $bank_member->bank_code }}"
                                        placeholder="{{ __('Auto') }}" required readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" class="form-control" name="bank_name" id="bank_name"
                                        value="{{ old('bank_name') ?? $bank_member->bank_name }}"
                                        placeholder="{{ __('Auto') }}" required readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" class="form-control" name="bank_type" id="bank_type"
                                        value="{{ old('bank_type') ?? $bank_member->bank_type }}"
                                        placeholder="{{ __('Auto') }}" required readonly>
                                </div>
                            </div>
                        </div>
