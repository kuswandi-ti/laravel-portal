...
@section('content')
    ...
    <div class="mt-2 mb-2 section">
        ...
        <form method="POST" action="{{ route('mobile.user.store') }}">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" name="street" id="street"
                                value="{{ old('street') }}" placeholder="{{ __('Auto') }}" required readonly>
                        </div>
                    </div>
                            ...
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" class="form-control" name="block" id="block"
                                        value="{{ old('block') }}" placeholder="{{ __('Auto') }}" required readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" class="form-control" name="no" id="no"
                                        value="{{ old('no') }}" placeholder="{{ __('Auto') }}" required readonly>
                                </div>
                            </div>
                        </div>
                    </div>
