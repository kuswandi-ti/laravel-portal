                        ...
                        <ul class="list-unstyled list-unstyled-border">
                            <li class="media">
                                ...
                                <img class="mr-3 rounded-circle" width="50" src="assets/img/avatar/avatar-4.png"
                                    alt="avatar">
                                <div class="media-body">
                                    <div class="float-right mb-1 badge badge-pill badge-danger">Not
                                        Finished</div>
                            ...
                            <li class="media">
                                ...
                                <img class="mr-3 rounded-circle" width="50" src="assets/img/avatar/avatar-5.png"
                                    alt="avatar">
                                <div class="media-body">
                                    <div class="float-right mb-1 badge badge-pill badge-primary">Completed
                                    </div>
                            ...
                            <li class="media">
                                ...
                                <img class="mr-3 rounded-circle" width="50" src="assets/img/avatar/avatar-2.png"
                                    alt="avatar">
                                <div class="media-body">
                                    <div class="float-right mb-1 badge badge-pill badge-warning">Progress
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="font-weight-600"><img
                                                    ...
                                                    class="mr-1 rounded-circle"> Bagus Dwi
                                                Cahya</a>
                                        </td>
                                        <td>
