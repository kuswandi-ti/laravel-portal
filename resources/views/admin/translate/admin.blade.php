...
@section('section_header_breadcrumb')
    @parent
    <div class="breadcrumb-item">{{ __('admin.Translate') }}</div>
@endsection
...
@section('section_body_lead')
    {{ __('admin.View information about translate on this page') }}
@endsection
                                            ...
                                            <div class="row">
                                                <form method="POST"
                                                    ...
                                                    <input type="hidden" name="directory"
                                                        value="{{ resource_path('views/admin') }},{{ app_path('Http/Controllers/Admin') }},{{ resource_path('views/mail') }},{{ resource_path('views/layouts/admin') }}">
